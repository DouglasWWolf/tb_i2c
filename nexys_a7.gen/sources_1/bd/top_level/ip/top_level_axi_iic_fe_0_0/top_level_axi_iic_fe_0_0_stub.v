...
module top_level_axi_iic_fe_0_0(clk, resetn, debug_sr_shows_rx, 
...
/* synthesis syn_black_box black_box_pad_pin="clk,resetn,debug_sr_shows_rx,debug_ocy_shows_rx,device_addr[6:0],i_I2C_REG_ADDR[15:0],i_I2C_INIT_wstrobe,i_I2C_READ_LEN[7:0],i_I2C_READ_LEN_wstrobe,o_I2C_IDLE,o_I2C_RX_DATA[31:0],AXI_AWADDR[31:0],AXI_AWVALID,AXI_AWPROT[2:0],AXI_AWREADY,AXI_WDATA[31:0],AXI_WVALID,AXI_WSTRB[3:0],AXI_WREADY,AXI_BRESP[1:0],AXI_BVALID,AXI_BREADY,AXI_ARADDR[31:0],AXI_ARVALID,AXI_ARPROT[2:0],AXI_ARREADY,AXI_RDATA[31:0],AXI_RVALID,AXI_RRESP[1:0],AXI_RREADY" */;
  input clk;
  input resetn;
